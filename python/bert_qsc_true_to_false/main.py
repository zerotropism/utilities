...
parser.add_argument('--data_dir', help='directory where data located', type=str)
...
(tsv_in_true_train, tsv_in_true_test) = split(args.data_dir, args.tsv_in_true, 0.2)
(tsv_out_false_train, tsv_out_false_test) = split(args.data_dir, args.tsv_out_false, 0.2)
