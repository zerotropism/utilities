...
parser.add_argument('--train_json_in', help='train JSON file to convert"', type=str)
parser.add_argument('--dev_json_in', help='dev JSON file to convert"', type=str)
parser.add_argument('--BERT_task', help='type of task for BERT, \"QSC\"', type=str)
parser.add_argument('--train_test_ration', help='ratio to split the given dataset, example \"0.2\" for \"80 in train\" and \"20 in test\"', type=float)
