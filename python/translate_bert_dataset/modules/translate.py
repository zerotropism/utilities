...
parser.add_argument('--language2language', help='en2fr"', type=str, default='NA')
parser.add_argument('--text2translate', help='text to translate in specified language"', type=str, default='NA')
